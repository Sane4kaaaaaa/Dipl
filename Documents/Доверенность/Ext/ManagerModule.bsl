...
Процедура Печать(ТабДок, Ссылка) Экспорт
	...
	Макет = Документы.Доверенность.ПолучитьМакет("Печать");
	Запрос = Новый Запрос;
	Запрос.Текст =
	"ВЫБРАТЬ
	|	Доверенность.Валюта,
	|	Доверенность.ВидОплаты,
	|	Доверенность.Дата,
	|	Доверенность.ДокументОснование,
